...
Error:
 ...
 1 │ my-command 100
   ...
   ·             ╰── fish right here
   ╰────
</code></pre></div>`,10);function u(g,p){const a=o("RouterLink");return n(),s("div",null,[m,t("p",null,[e("Using the "),c(a,{to:"/book/metadata.html"},{default:i(()=>[e("metadata")]),_:1}),e(" information, you can create your own custom error messages. Error messages are built of multiple parts:")]),h])}const f=r(l,[["render",u],["__file","creating_errors.html.vue"]]);export{f as default};
