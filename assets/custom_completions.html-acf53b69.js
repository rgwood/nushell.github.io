...
`)])],-1),$=e("blockquote",null,[e("p",null,"When the block returns unparsable json (e.g. an empty string) it defaults to file completion.")],-1);function I(N,C){const n=a("RouterLink"),l=a("ExternalLinkIcon");return m(),r("div",null,[u,e("p",null,[t("Custom completions allow you to mix together two features of Nushell: custom commands and completions. With them, you're able to create commands that handle the completions for positional parameters and flag parameters. These custom completions work both custom commands and "),o(n,{to:"/book/externs.html"},{default:s(()=>[t("known external, or "),p,t(", commands")]),_:1}),t(".")]),h,e("p",null,[t("A powerful combination is adding custom completions to "),o(n,{to:"/book/externs.html"},{default:s(()=>[t("known "),f,t(" commands")]),_:1}),t(". These work the same way as adding a custom completion to a custom command: by creating the custom completion and then attaching it with a "),g,t(" to the type of one of the positional or flag arguments of the "),x,t(".")]),_,e("p",null,[t("External completers can also be integrated, instead of relying solely on Nushell ones. For this set the "),b,t(" field in "),w,t(" to a block which will be evaluated if no Nushell completions were found. You can configure the block to run an external completer, such as "),e("a",y,[t("carapace"),o(l)]),t(".")]),q,v,k,T,$])}const L=i(d,[["render",I],["__file","custom_completions.html.vue"]]);export{L as default};
