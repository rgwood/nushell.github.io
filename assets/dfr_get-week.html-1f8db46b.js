...
├───┼────┤
│ <span class="token number">0</span> │ <span class="token number">32</span> │
│ <span class="token number">1</span> │ <span class="token number">32</span> │
╰───┴────╯

</code></pre></div>`,5);function k(n,f){return o(),p("div",null,[a("h1",l,[i,s(),a("code",null,e(n.$frontmatter.title),1),s(" for dataframe")]),a("div",d,e(n.$frontmatter.dataframe),1),u])}const h=t(c,[["render",k],["__file","dfr_get-week.html.vue"]]);export{h as default};
