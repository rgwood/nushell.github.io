import{_ as i,M as d,p as l,q as r,Q as e,t,N as n,U as a,a1 as s}from"./framework-344bb0e4.js";const u={},c=s(`<h1 id="modules" tabindex="-1"><a class="header-anchor" href="#modules" aria-hidden="true">#</a> Modules</h1><p>Similar to many other programming languages, Nushell also has modules that let you import custom commands into a current scope. However, since Nushell is also a shell, modules allow you to import environment variables which can be used to conveniently activate/deactivate various environments.</p><h2 id="basics" tabindex="-1"><a class="header-anchor" href="#basics" aria-hidden="true">#</a> Basics</h2><p>A simple module can be defined like this:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; module greetings {
...
</code></pre></div>`,11),$=e("code",null,"use",-1),k=s(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; use greetings.nu
...
</code></pre></div><h2 id="environment-variables" tabindex="-1"><a class="header-anchor" href="#environment-variables" aria-hidden="true">#</a> Environment Variables</h2>`,8),E=e("code",null,"export-env",-1),M=s(`<div class="language-text" data-ext="text"><pre class="language-text"><code># greetings.nu
