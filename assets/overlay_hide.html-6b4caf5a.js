import{_ as t,p as o,q as p,Q as a,t as n,v as s,a1 as r}from"./framework-344bb0e4.js";const c={},l={id:"frontmatter-title-for-core",tabindex:"-1"},i=a("a",{class:"header-anchor",href:"#frontmatter-title-for-core","aria-hidden":"true"},"#",-1),d={class:"command-title"},u=r(`<h2 id="signature" tabindex="-1"><a class="header-anchor" href="#signature" aria-hidden="true">#</a> Signature</h2><p><code>&gt; overlay hide (name) --keep-custom --keep-env</code></p><h2 id="parameters" tabindex="-1"><a class="header-anchor" href="#parameters" aria-hidden="true">#</a> Parameters</h2><ul><li><code>name</code>: Overlay to hide</li><li><code>--keep-custom</code> <code>(-k)</code>: Keep all newly added commands and aliases in the next activated overlay</li><li><code>--keep-env {list&lt;string&gt;}</code>: List of environment variables to keep in the next activated overlay</li></ul><h2 id="notes" tabindex="-1"><a class="header-anchor" href="#notes" aria-hidden="true">#</a> Notes</h2><p>This command is a parser keyword. For details, check: https://www.nushell.sh/book/thinking_in_nu.html</p><h2 id="examples" tabindex="-1"><a class="header-anchor" href="#examples" aria-hidden="true">#</a> Examples</h2><p>Keep a custom command after hiding the overlay</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> module spam <span class="token punctuation">{</span> <span class="token builtin class-name">export</span> def foo <span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token punctuation">{</span> <span class="token string">&quot;foo&quot;</span> <span class="token punctuation">}</span> <span class="token punctuation">}</span>
    overlay use spam
...
</code></pre></div>`,15);function h(e,m){return o(),p("div",null,[a("h1",l,[i,n(),a("code",null,s(e.$frontmatter.title),1),n(" for core")]),a("div",d,s(e.$frontmatter.core),1),u])}const v=t(c,[["render",h],["__file","overlay_hide.html.vue"]]);export{v as default};
