import{_ as e,p as n,q as t,a1 as d}from"./framework-344bb0e4.js";const i={},a=d(`<h1 id="polars-vs-pandas-vs-nushell" tabindex="-1"><a class="header-anchor" href="#polars-vs-pandas-vs-nushell" aria-hidden="true">#</a> Polars vs Pandas vs Nushell</h1><p>A dataframe example based on https://studioterabyte.nl/en/blog/polars-vs-pandas</p><h2 id="_1-opening-the-file-and-show-the-shape-of-the-dataframe" tabindex="-1"><a class="header-anchor" href="#_1-opening-the-file-and-show-the-shape-of-the-dataframe" aria-hidden="true">#</a> 1. Opening the file and show the shape of the DataFrame</h2><div class="language-console" data-ext="console"><pre class="language-console"><code>&gt; let df = (dfr open NYCTaxi.csv)
