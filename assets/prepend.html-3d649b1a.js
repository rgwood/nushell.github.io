...
│ <span class="token number">0</span> │     <span class="token number">0</span> │
│ <span class="token number">1</span> │     <span class="token number">1</span> │
│ <span class="token number">2</span> │ rocks │
│ <span class="token number">3</span> │     <span class="token number">2</span> │
│ <span class="token number">4</span> │ nu    │
│ <span class="token number">5</span> │     <span class="token number">4</span> │
│ <span class="token number">6</span> │ shell │
╰───┴───────╯

</code></pre></div>`,13);function m(a,k){return p(),o("div",null,[n("h1",l,[u,s(),n("code",null,e(a.$frontmatter.title),1),s(" for filters")]),n("div",i,e(a.$frontmatter.filters),1),d])}const b=t(c,[["render",m],["__file","prepend.html.vue"]]);export{b as default};
