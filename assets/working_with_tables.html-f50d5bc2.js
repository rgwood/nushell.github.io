...
───┴───────────────┴─────────
`)])],-1),x=e("p",null,"This helps to create a table that's more focused on what we need. Next, let's say we want to only look at the 5 smallest files in this directory:",-1),w=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> ls | sort-by size | first 5
───┬──────────────┬──────┬────────┬────────────
 # │ name         │ type │ size   │ modified
───┼──────────────┼──────┼────────┼────────────
 0 │ lib.rs       │ File │  330 B │ 5 days ago
...
───┴───────────┴──────┴────────┴────────────
`)])],-1),B=e("p",null,"We've narrowed it to three rows we care about.",-1),k=e("code",null,"select",-1),K=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> ls | sort-by name
───┬───────────────┬──────┬─────────┬────────────
 # │ name          │ type │ size    │ modified
───┼───────────────┼──────┼─────────┼────────────
 0 │ files.rs      │ File │  4.6 KB │ 5 days ago
...
───┴───────────────┴──────┴─────────┴────────────
`)])],-1),F=e("h2",{id:"getting-data-out-of-a-table",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#getting-data-out-of-a-table","aria-hidden":"true"},"#"),t(" Getting data out of a table")],-1),z=e("code",null,"get",-1),$=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> ls | get name
───┬───────────────
 0 │ files.rs
 1 │ lib.rs
 2 │ lite_parse.rs
 ...
 6 │ signature.rs
───┴───────────────
`)])],-1),T=e("p",null,"We now have the values for each of the filenames.",-1),L=e("code",null,"select",-1),j=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> ls | select name
───┬───────────────
 # │ name
───┼───────────────
 0 │ files.rs
 ...
 6 │ signature.rs
───┴───────────────
`)])],-1),N=e("p",null,"These look very similar! Let's see if we can spell out the difference between these two commands to make it clear:",-1),W=e("code",null,"select",-1),D=e("code",null,"get",-1),I=e("p",null,"The one way to tell these apart looking at the table is that the column names are missing, which lets us know that this is going to be a list of values we can work with.",-1),Y=e("code",null,"get",-1),C=e("h2",{id:"changing-data-in-a-table",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#changing-data-in-a-table","aria-hidden":"true"},"#"),t(" Changing data in a table")],-1),S=e("p",null,"In addition to selecting data from a table, we can also update what the table has. We may want to combine tables, add new columns, or edit the contents of a cell. In Nu, rather than editing in place, each of the commands in the section will return a new table in the pipeline.",-1),A=e("h3",{id:"concatenating-tables",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#concatenating-tables","aria-hidden":"true"},"#"),t(" Concatenating Tables")],-1),R=e("code",null,"append",-1),V=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> let $first = [[a b]; [1 2]]
> let $second = [[a b]; [3 4]]
> $first | append $second
───┬───┬───
 # │ a │ b
───┼───┼───
 ...
 1 │ 3 │ 4
───┴───┴───
`)])],-1),q=e("h3",{id:"merging-tables",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#merging-tables","aria-hidden":"true"},"#"),t(" Merging Tables")],-1),M=e("code",null,"merge",-1),O=o(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; let $first = [[a b]; [1 2]]
&gt; let $second = [[c d]; [3 4]]
&gt; $first | merge $second
───┬───┬───┬───┬───
 # │ a │ b │ c │ d
...
...
`)])],-1),re=e("h3",{id:"renaming-columns",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#renaming-columns","aria-hidden":"true"},"#"),t(" Renaming columns")],-1),ce=e("code",null,"rename",-1),he=e("code",null,"ls",-1),ue=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> ls | rename filename filetype filesize date
╭────┬───────────────────┬──────────┬──────────┬──────────────╮
...
...
`)])],-1),me=e("h3",{id:"rejecting-deleting-columns",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#rejecting-deleting-columns","aria-hidden":"true"},"#"),t(" Rejecting/Deleting columns")],-1),ge=e("code",null,"reject",-1),pe=e("code",null,"ls",-1),_e=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> ls -l / |reject readonly num_links inode created accessed modified
╭────┬────────┬─────────┬─────────┬───────────┬──────┬───────┬────────╮
